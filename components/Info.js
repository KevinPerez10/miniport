...
export default function Info() {
    return (
        <div className="info">
            <h1 className="info--name"> Kevin Perez </h1>
            <h2 className="info--profession"> Frontend Developer </h2>
            <h3 className="info--website__name"> Kevin's Website </h3>
            <button className="info--button">
                <div className="info--button--svg">
                ...
                <div className="info--button--email__text">
                    Email
                </div> 
             </button>
        </div>
